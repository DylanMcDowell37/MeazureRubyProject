class Api::V1::ExamRegistrationsController < ApplicationController
  ...
  def create
    @user = User.create_or_find_by(first_name: exam_registration_params[:first_name], last_name: exam_registration_params[:last_name], phone_number: exam_registration_params[:phone_number])
